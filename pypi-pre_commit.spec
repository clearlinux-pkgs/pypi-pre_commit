...
%prep
%setup -q -n pre_commit-2.19.0
cd %{_builddir}/pre_commit-2.19.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651797487
...
cp %{_builddir}/pre_commit-2.19.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pre_commit/0a1b7c6ad0735b8a94231652bab67240e4b834f6
