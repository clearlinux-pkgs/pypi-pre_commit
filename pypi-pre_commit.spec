...
Source0  : https://files.pythonhosted.org/packages/7e/ba/4d263a47ded76149dcbd11a1cc4035413f5765ffe407810338209c2a2d43/pre_commit-3.0.4.tar.gz
...
%prep
%setup -q -n pre_commit-3.0.4
cd %{_builddir}/pre_commit-3.0.4
pushd ..
cp -a pre_commit-3.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675636526
