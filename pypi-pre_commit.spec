...
Source0  : https://files.pythonhosted.org/packages/87/a2/169794a73e0ad229ddbe93b5b8da2060dd92f39df724eb38ccc55c7f84f1/pre_commit-3.0.0.tar.gz
...
%prep
%setup -q -n pre_commit-3.0.0
cd %{_builddir}/pre_commit-3.0.0
pushd ..
cp -a pre_commit-3.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674576653
