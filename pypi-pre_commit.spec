...
Source0  : https://files.pythonhosted.org/packages/1e/ba/8cf8b88d0e07588818de46877effc9971305541d9421bc6377b06639d135/pre_commit-2.20.0.tar.gz
...
%prep
%setup -q -n pre_commit-2.20.0
cd %{_builddir}/pre_commit-2.20.0
pushd ..
cp -a pre_commit-2.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657555240
...
cp %{_builddir}/pre_commit-2.20.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pre_commit/0a1b7c6ad0735b8a94231652bab67240e4b834f6
