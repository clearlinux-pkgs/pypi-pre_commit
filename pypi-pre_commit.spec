...
Source0  : https://files.pythonhosted.org/packages/60/62/691bb4109735ea4b8eb69f4a68110ece4c7ec4a7ce0144996e7302eb5eef/pre_commit-3.7.0.tar.gz
...
%prep
%setup -q -n pre_commit-3.7.0
cd %{_builddir}/pre_commit-3.7.0
pushd ..
cp -a pre_commit-3.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711313757
