...
Source0  : https://files.pythonhosted.org/packages/aa/46/cc214ef6514270328910083d0119d0a80a6d2c4ec8c6608c0219db0b74cf/pre_commit-3.7.1.tar.gz
...
%prep
%setup -q -n pre_commit-3.7.1
cd %{_builddir}/pre_commit-3.7.1
pushd ..
cp -a pre_commit-3.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715622139
