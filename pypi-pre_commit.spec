...
Source0  : https://files.pythonhosted.org/packages/64/10/97ee2fa54dff1e9da9badbc5e35d0bbaef0776271ea5907eccf64140f72f/pre_commit-3.8.0.tar.gz
...
%prep
%setup -q -n pre_commit-3.8.0
cd %{_builddir}/pre_commit-3.8.0
pushd ..
cp -a pre_commit-3.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722275420
