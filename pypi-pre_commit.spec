...
Source0  : https://files.pythonhosted.org/packages/2a/13/b62d075317d8686071eb843f0bb1f195eb332f48869d3c31a4c6f1e063ac/pre_commit-4.1.0.tar.gz
...
%prep
%setup -q -n pre_commit-4.1.0
cd %{_builddir}/pre_commit-4.1.0
pushd ..
cp -a pre_commit-4.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737471350
