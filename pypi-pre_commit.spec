...
Source0  : https://files.pythonhosted.org/packages/04/b3/4ae08d21eb097162f5aad37f4585f8069a86402ed7f5362cc9ae097f9572/pre_commit-3.5.0.tar.gz
...
%prep
%setup -q -n pre_commit-3.5.0
cd %{_builddir}/pre_commit-3.5.0
pushd ..
cp -a pre_commit-3.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697216315
