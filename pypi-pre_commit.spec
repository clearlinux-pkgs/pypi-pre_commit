...
Source0  : https://files.pythonhosted.org/packages/08/39/679ca9b26c7bb2999ff122d50faa301e49af82ca9c066ec061cfbc0c6784/pre_commit-4.2.0.tar.gz
...
%prep
%setup -q -n pre_commit-4.2.0
cd %{_builddir}/pre_commit-4.2.0
pushd ..
cp -a pre_commit-4.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742430542
