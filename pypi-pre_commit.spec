...
Source0  : https://files.pythonhosted.org/packages/ea/2b/8999b0cfde3c72f153c489e93a6a5e8621a7e57f33f6fa78942bb771d79e/pre_commit-3.1.1.tar.gz
...
%prep
%setup -q -n pre_commit-3.1.1
cd %{_builddir}/pre_commit-3.1.1
pushd ..
cp -a pre_commit-3.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677601280
