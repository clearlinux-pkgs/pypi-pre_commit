...
Source0  : https://files.pythonhosted.org/packages/88/e8/4330d06f2b00ad3a9c66e07a68fe23f70233a4e7e1aaba5a738a93d2cb5d/pre_commit-3.6.0.tar.gz
...
%prep
%setup -q -n pre_commit-3.6.0
cd %{_builddir}/pre_commit-3.6.0
pushd ..
cp -a pre_commit-3.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702929518
