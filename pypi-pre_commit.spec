...
Source0  : https://files.pythonhosted.org/packages/d4/27/dcc5671be62457ec522ad1157422e78c416011ea12a0be022f1380807093/pre_commit-3.0.2.tar.gz
...
%prep
%setup -q -n pre_commit-3.0.2
cd %{_builddir}/pre_commit-3.0.2
pushd ..
cp -a pre_commit-3.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675096210
