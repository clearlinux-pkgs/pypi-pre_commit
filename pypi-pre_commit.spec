...
Source0  : https://files.pythonhosted.org/packages/97/e9/26c7a792c8793e844ccfdac1e832136909f9a49dde32550b961edfacb51e/pre_commit-3.0.3.tar.gz
...
%prep
%setup -q -n pre_commit-3.0.3
cd %{_builddir}/pre_commit-3.0.3
pushd ..
cp -a pre_commit-3.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675377980
