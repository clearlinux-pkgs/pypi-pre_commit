...
Source0  : https://files.pythonhosted.org/packages/61/52/ade3c4d7cb8753ca1e6a8473dc6161f27f3dbd7195b7bf1dc02e4f59e848/pre_commit-3.1.0.tar.gz
...
%prep
%setup -q -n pre_commit-3.1.0
cd %{_builddir}/pre_commit-3.1.0
pushd ..
cp -a pre_commit-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677184877
