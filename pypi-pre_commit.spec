...
Source0  : https://files.pythonhosted.org/packages/58/d7/789ed835d4043cec0bcc21ff14fb1a03bf93a192419136ea36f8df721c3b/pre_commit-2.18.1.tar.gz
...
%prep
%setup -q -n pre_commit-2.18.1
cd %{_builddir}/pre_commit-2.18.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649035037
...
cp %{_builddir}/pre_commit-2.18.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pre_commit/0a1b7c6ad0735b8a94231652bab67240e4b834f6
